<%@ Page Title="" Language="C#" MasterPageFile="~/admin.master" AutoEventWireup="true" CodeFile="ViewRecent.aspx.cs" Inherits="Account_Home" %>

<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" Runat="Server">
   </asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" Runat="Server">
    <h1> UPDATE RECENT EVENTS</h1>
...
<ItemTemplate>
<asp:Image ID="image" runat="server" Height="200 px" ImageUrl='<%# "ImageHandler2.ashx?ImID="+ Eval("title") %>' />
</ItemTemplate>
</asp:TemplateField>
</Columns>
