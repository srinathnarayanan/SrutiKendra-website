...
public partial class Account_Home : System.Web.UI.Page
{
    ...
    protected void btnUpload_Click(object sender, EventArgs e)
    {
        ...
        if (fileuploadImage.HasFile)
        {
            ...
            connection.Open();
            SqlCommand cmd = new SqlCommand("INSERT INTO Upcoming (title,short,long,image) VALUES (@InsertTitle,@InsertShort,@InsertLong,@imagedata)", connection);
    ...
    {
        SqlConnection connection = new SqlConnection(strcon);
        SqlCommand command = new SqlCommand("SELECT title,short,long,image from [Upcoming]", connection);
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            cmd.CommandText = "Delete FROM Upcoming where title='" + id + "'";
